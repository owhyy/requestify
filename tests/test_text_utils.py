...
class TestBaseGeneration:
    ...
    def test_indent_function_inside_class(self, unindented_function):
        ...
        assert (
            _indent_function_inside_class(unindented_function)
            == indented_function
        )
    ...
    def test_indent_function_outside_class(self, unindented_function):
        ...
        assert (
            _indent_function_outside_class(unindented_function)
            == indented_function
        )
...
class TestModelTextGeneration(object):
    ...
    def test_base_requstify_full(self):
        ...
        assert (
            generate_requestify_base_text(req, True, True)
            == base_response_text
        )
    ...
    def test_base_requestify_no_headers(self):
        ...
        assert (
            generate_requestify_base_text(
                req, with_headers=False, with_cookies=True
            )
            == base_response_text
        )
    ...
    def test_base_requestify_no_cookies(self):
        ...
        assert (
            generate_requestify_base_text(req, True, False)
            == base_response_text
        )
    ...
    def test_base_requestify_no_headers_no_cookies(self):
        ...
        assert (
            generate_requestify_base_text(req, False, False)
            == base_response_text
        )
    ...
    def test_base_requestify_no_headers_no_data(self):
        ...
        assert (
            generate_requestify_base_text(req, False, True)
            == base_response_text
        )
    ...
    def test_generate_replacement_no_matching_data(self, mocker):
        ...
        assert generate_class_text(
            generate_replacement(rreq)
        ) == generate_class_text(text)
